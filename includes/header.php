...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Preguntamos si la seccion ese S_USUARIO existe, solo en tal caso
            mostramos el texto bienvenido-->
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <!--Aqui preguntamos si la seccion ese usuario No existe 
                        pues solo en ese caso se debe mostrar la opcion debe ingresar--> 
                        <?php if(!isset($_SESSION['S_USUARIO'])) {?>
                            <div class="nav">
                        ...
                        <!--Aqui inicia todas las opciones-->
                            ...
                            <div class="nav">
                                <a class="nav-link" href="<?=RUTA_GENERAL; ?>source/admin/crear_postulantes.php">
                                    <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>
                                    Registrarse
                                </a>
                            </div>
